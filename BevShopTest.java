...
public class BevShopTest {
	...
	public void testStartNewOrder()
	{
		...
		assertEquals(8, bevShop.getCurrentOrder());
		System.out.println("1");
		System.out.println(bevShop.getCurrentOrder().getOrderTime());
	...
	public void testProcessSmoothieOrder()
	{
		...
		assertFalse(sm.hasProteinPowder());
		...
		assertTrue(sm.hasProteinPowder());
		assertEquals(1,bevShop.totalNumOfMonthlyOrders());
	...
	public void testProcessCoffeeOrder()
	{
		...
		assertTrue(cf.hasExtraShot()); 
		assertFalse(cf.hasExtraSyrup()); 
